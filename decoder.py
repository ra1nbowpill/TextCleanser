...
class Decoder():
    ...
    def start_ngram_server(self):
        ...
        ngram_server_command = LATTICE_TOOL_DIR + "ngram -lm " + LM_DIR + "tweet-lm.gz -mix-lm " + \
            LM_DIR + "latimes-lm.gz -lambda 0.7 -mix-lambda2 0.3 -server-port 12345 &"
    ...
    def decode(self, word_mesh):
        ...
        command = "{}lattice-tool -in-lattice - -read-mesh -posterior-decode -zeroprob-word blemish -use-server {} ".format(
            LATTICE_TOOL_DIR, NGRAM_SERVER_IP)
        try:
